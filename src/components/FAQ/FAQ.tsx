...
const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      'כל מסלול כולל מדריך מוסמך, ציוד בטיחות מלא (קסדה, כפפות, עורף), ביטוח אישי, כיבוד ונשנושים בדרך. מסלולי eMTB כוללים גם אופניים חשמליות Premium. ארוחות מלאות מצוינות בפירוט המסלול.',
  },
  {
    id: '3',
